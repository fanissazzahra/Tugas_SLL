	...
	do{
		...
		switch(menu){
			...
			case 2:
					...
					break;
			case 3:
					cout << "Pilih node yang ingin ditambahkan : ";cin>>pos;
					cout << "Masukan Angka : ";cin>>val;
			...
			case 5:
					...
					break;
			case 6:
					cout << "Pilih node yang ingin dihapus : ";cin>>pos;
...
int nama_menu(){
	...
	cout << "3. Insert Last/After"<<endl;
	cout << "4. Deletion First"<<endl;
	cout << "5. Deletion Last"<<endl;
	cout << "6. Deletion Last/After"<<endl;
